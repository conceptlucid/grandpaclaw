...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: GrandpaClawProtocol.AnyCodable]?
    {
        ...
        return [
            "id": GrandpaClawProtocol.AnyCodable(identity.deviceId),
            "publicKey": GrandpaClawProtocol.AnyCodable(publicKey),
            "signature": GrandpaClawProtocol.AnyCodable(signature),
            "signedAt": GrandpaClawProtocol.AnyCodable(signedAtMs),
            "nonce": GrandpaClawProtocol.AnyCodable(nonce),
        ]
    }
}
