...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = GrandpaClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = GrandpaClawConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: GrandpaClawConfigFile.loadDict(),
        ...
        GrandpaClawConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/grandpaclaw"
        state.remoteCliPath = ""
        return state
    }
}
