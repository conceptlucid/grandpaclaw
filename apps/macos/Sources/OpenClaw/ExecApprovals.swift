...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.grandpaclaw", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        GrandpaClawPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        GrandpaClawPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
