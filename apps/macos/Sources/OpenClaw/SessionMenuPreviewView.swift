...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.grandpaclaw", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> GrandpaClawSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: GrandpaClawSessionPreviewEntry,
    ...
    private static func cache(payload: GrandpaClawSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: GrandpaClawChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [GrandpaClawKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [GrandpaClawKit.AnyCodable]) -> [GrandpaClawChatMessage] {
    ...
    private static func previewText(for message: GrandpaClawChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: GrandpaClawChatMessage) -> Bool {
    ...
    private static func toolNames(for message: GrandpaClawChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: GrandpaClawChatMessage) -> String? {
