...
enum UIStrings {
    static let welcomeTitle = "Welcome to GrandpaClaw"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "grandpaclaw.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: GrandpaClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g grandpaclaw@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: GrandpaClawChatViewModel(
