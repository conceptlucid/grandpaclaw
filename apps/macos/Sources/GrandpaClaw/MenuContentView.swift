...
/// Menu contents for the GrandpaClaw menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About GrandpaClaw") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "GrandpaClaw Not Configured"
        case .remote:
            "Remote GrandpaClaw Active"
        case .local:
            "GrandpaClaw Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .grandpaclawSelectSettingsTab, object: tab)
        }
    }
