...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.grandpaclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".grandpaclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.grandpaclawCommand(
            subcommand: "gateway",
