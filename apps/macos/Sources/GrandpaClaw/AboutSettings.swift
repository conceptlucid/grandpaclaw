...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/grandpaclaw/grandpaclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/grandpaclaw/grandpaclaw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://grandpaclaw.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "GrandpaClawBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "GrandpaClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "GrandpaClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "GrandpaClawGitCommit") as? String) ??
            "unknown"
    }
