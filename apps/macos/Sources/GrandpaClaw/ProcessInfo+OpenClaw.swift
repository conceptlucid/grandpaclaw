...
extension ProcessInfo {
    ...
    /// Nix deployments may write defaults into a stable suite (`ai.grandpaclaw.mac`) even if the shipped
        ...
        isAppBundle: Bool) -> Bool
    {
        ...
        if standard.bool(forKey: "grandpaclaw.nixMode") { return true }
        ...
        if isAppBundle, let stableSuite, stableSuite.bool(forKey: "grandpaclaw.nixMode") { return true }
