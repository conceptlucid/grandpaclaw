...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.grandpaclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("GrandpaClaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__grandpaclaw__/a2ui/").absoluteString + "?platform=macos"
    }
