...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.grandpaclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return GrandpaClawConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - GrandpaClaw Workspace
    ...
    static func defaultBootstrapTemplate() -> String {
        ...
        3) ~/.grandpaclaw/grandpaclaw.json
