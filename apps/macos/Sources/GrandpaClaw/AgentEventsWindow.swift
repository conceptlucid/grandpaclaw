...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: GrandpaClawProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": GrandpaClawProtocol.AnyCodable("start"),
                "name": GrandpaClawProtocol.AnyCodable("bash"),
            ],
            summary: nil)
