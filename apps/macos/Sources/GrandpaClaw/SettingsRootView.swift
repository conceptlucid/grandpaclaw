...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .grandpaclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? GrandpaClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? GrandpaClawPaths.stateDirURL.path
...
extension Notification.Name {
    static let grandpaclawSelectSettingsTab = Notification.Name("grandpaclawSelectSettingsTab")
}
