...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.grandpaclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other GrandpaClaw windows, but below the system’s pop-up menus.
